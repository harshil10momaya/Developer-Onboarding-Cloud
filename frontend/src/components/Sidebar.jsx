...
const Sidebar = ({ currentPage }) => {
  ...
  const items = [
    ...
    { id: 'learning-paths', label: 'Learning Paths', icon: '🛤️', path: '/learning-paths', roles: ['developer'] },
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-header"><div className="logo">☁️</div><h2>Developer Onboarding Cloud</h2></div>
      ...
      <div className="sidebar-footer">
        {user && (<div className="sidebar-user"><div className="sidebar-user-info"><span className="sidebar-user-avatar">👤</span><div><p className="sidebar-user-name">{user.full_name}</p><p className="sidebar-user-role">{user.role}</p></div></div><button className="sidebar-logout-btn" onClick={logout}>Logout</button></div>)}
